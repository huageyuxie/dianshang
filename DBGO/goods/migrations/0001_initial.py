    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goodtype_cover', models.ImageField(default='static/images/goods/default/default.jpg', upload_to='static/images/goods', verbose_name='商品类型图片')),
        ...
        migrations.AddField(
            model_name='goods',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stores.Store', verbose_name='商品店铺'),
        ),
    ]
